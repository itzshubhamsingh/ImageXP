...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.PostHolder>{
    ...
    public PostHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View mView = LayoutInflater.from(context).inflate(R.layout.sample_recycler , parent , false);
    ...
    public class PostHolder extends RecyclerView.ViewHolder{
        ...
        public void setmLikes(int likes){
            mLikes = view.findViewById(R.id.sample_like);
            mLikes.setText(likes + " Likes");
        }
        public void setmTags(String tag){
            mTags = view.findViewById(R.id.sample_tag);
            mTags.setText(tag);
        }
    }
}
